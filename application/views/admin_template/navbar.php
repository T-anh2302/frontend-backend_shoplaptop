      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?php echo base_url('category/create') ?>">Add Category Product</a>
              <a class="dropdown-item" href="<?php echo base_url('category/list') ?>">List Category Product</a>    
            </div>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?php echo base_url('category_blog/create') ?>">Add Category BLog</a>
              <a class="dropdown-item" href="<?php echo base_url('category_blog/list') ?>">List Category Blog</a>    
            </div>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?php echo base_url('post/create') ?>">Add Post</a>
              <a class="dropdown-item" href="<?php echo base_url('post/list') ?>">List Posts</a>    
            </div>
          </li>
