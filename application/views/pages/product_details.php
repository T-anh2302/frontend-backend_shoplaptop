            ...
            <form action="<?php echo base_url('add-to-cart') ?>" method="POST">
              <div class="col-sm-7">
                ...
                <div class="product-information"><!--/product-information-->
                  ...
                  <p><b>Availability:</b> Trong kho</p>
                  <p><b>Tình trạng:</b> <?php echo $pro->status ?></p>
								...
								?>
									...
									<form action="#">
										<span>
											...
											<input type="text" required class="name_comment" placeholder="Họ và tên..."/>
											<input type="email" class="email_comment" required placeholder="Email..."/>
										</span>
										<textarea name="" class="comment" placeholder="Viết đánh giá..." required ></textarea>
										<!--------------Rating------------------>
										<img src="images/product-details/rating.png" alt="" />
